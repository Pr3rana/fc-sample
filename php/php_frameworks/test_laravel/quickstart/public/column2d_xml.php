        ...
        <?php
            ...
            */
            $columnChart = new FusionCharts("column2d", "myFirstChart" , 600, 300, "chart-1", "xml",
                                            '<chart caption="Caption" subcaption="subCaption" xaxisname="XaxisName" plotToolText="$displayValue.%" yaxisname="Sales" linethickness="2" basefontcolor="#333333" basefont="Helvetica Neue,Arial" captionfontsize="14" subcaptionfontsize="14" subcaptionfontbold="0" showvalues="0" bgcolor="#000000" bgalpha="30" showshadow="0" canvasbgcolor="#ffffff" canvasborderalpha="0" divlinealpha="100" divlinecolor="#999999" divlinethickness="1" divlinedashed="1" divlinedashlen="1" exportEnabled="1" divlinegaplen="1" showxaxisline="1" xaxislinethickness="1" xaxislinecolor="#999999" showalternatehgridcolor="0" theme="fint"><set displayValue="15.12" label="Mon" value="15123" /><set displayValue="14.23" label="Tue" value="14233" /><set displayValue="23.51" label="Wed" value="23507" /><set displayValue="9.11" label="Thur" value="9110" /><set displayValue="15.53" label="fri" value="15529" /><set displayValue="20.8" label="Sat" value="20803" /><set displayValue="19.2" label="Sun" value="19202" /></chart>'
                                        );
            // Render the chart
            $columnChart->render();
        ?>
